package org.firstinspires.ftc.teamcode.drive.opmode.autos.blue.far;
...
public class FarLeftBlue {
    ...
    public void run(HardwareMap hardwareMap) {
        ...
        Trajectory pushProp = drivetrain.trajectoryBuilder(new Pose2d(24,2,Math.toRadians(90)))
                .lineToLinearHeading(new Pose2d(22, 22, Math.toRadians(90)))
                .build();
        drivetrain.followTrajectory(pushProp);

        Trajectory toPurpleSpike = drivetrain.trajectoryBuilder(new Pose2d(22,22,Math.toRadians(90)))
        ...
        Trajectory drop = drivetrain.trajectoryBuilder(new Pose2d(22, 15.5, Math.toRadians(90)))
                .lineToLinearHeading(new Pose2d(21, 14.5, Math.toRadians(90)))
                .build();

...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 0.95;

    public static double Y_MULTIPLIER = 0.95;
    ...
    public TwoWheelTrackingLocalizer(HardwareMap hardwareMap, SampleMecanumDrive drive) {
        ...
        parallelEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "frontL"));
        perpendicularEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "backL"));

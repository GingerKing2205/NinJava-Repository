...
public class RedLeft {
    ...
    public void runOpMode(HardwareMap hardwareMap, Telemetry telemetry) throws InterruptedException {
        ...
        if (1 == 1) {
            ...
            reset_odo();
            while (!(left_back_drive.getCurrentPosition() >= 48000)) {//strafe right
            ...
            //
            while (!(Noose.getCurrentPosition() <= -350)) {
                Noose.setPower(-1);
            }
            Noose.setPower(0);
            while (!(Slide.getCurrentPosition() >= 850)) {
                Slide.setPower(0.5);
            }
            Slide.setPower(0);
            ...
            //slight right strafe
            reset_odo();
            while (!(left_back_drive.getCurrentPosition() >= 8000)) {
                left_back_drive.setPower(-0.5);
                left_front_drive.setPower(0.5);
                right_back_drive.setPower(0.5);
                right_front_drive.setPower(-0.5);

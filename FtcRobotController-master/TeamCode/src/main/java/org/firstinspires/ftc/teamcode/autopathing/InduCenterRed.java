...
public class InduCenterRed {
    ...
    public void runOpMode(HardwareMap hardwareMap, Telemetry telemetry) throws InterruptedException {
        ...
        // Noose.setPower(0);
            ...
            DT_power_0();
            reset_odo();
            while (!(left_back_drive.getCurrentPosition() >= 38000)) {
            ...
            DT_power_0();
            reset_odo();
            while (right_back_drive.getCurrentPosition() >= -51500) { // was 47000
                left_back_drive.setPower(0.3);
                left_front_drive.setPower(0.3);
                right_back_drive.setPower(0.3);
                right_front_drive.setPower(0.3);
            ...
            reset_odo();
            while (!(Noose.getCurrentPosition() <= -970)) {
                Noose.setPower(-1);
            }
            Noose.setPower(0);
            while (!(Slide.getCurrentPosition() >= 10)) { //was 300
                Slide.setPower(1);
            }
            Slide.setPower(0);
            sleep(500);
            intake.setPower(0.38); //was .45
            ...
            while (armOn == true) {
                ...
                if (!(left_back_drive.getCurrentPosition() <= -4000)) {//was 18000
                    ...
                    if (right_back_drive.getCurrentPosition() <= 300) { //was 4000  -> 25000
                        Noose.setTargetPosition((int) (FlipStep * 0.545 + knot));
                        left_back_drive.setPower(-0.2);
                        left_front_drive.setPower(-0.2);
                        right_back_drive.setPower(-0.2);
                        ...
                        Noose.setTargetPosition(50); //was -200

                        if (Noose.getCurrentPosition() < 50){ // was -190
                            sleep(1000);
                            arm.target = 0;
                            if (!(left_back_drive.getCurrentPosition() <= -25000)) {// was -25000
                                //  Noose.setTargetPosition((int) (FlipStep * 0.545 + knot));
                                left_back_drive.setPower(0.5);
                                left_front_drive.setPower(-0.5);
                                right_back_drive.setPower(-0.5);

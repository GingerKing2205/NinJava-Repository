...
//@Autonomous
public class CloseCenterBlue/* extends LinearOpMode*/ {
    ...
    public void run/*OpMode*/(HardwareMap hardwareMap) {
        ...
        Trajectory toBD1 = drivetrain.trajectoryBuilder(new Pose2d(24.5,4.5,0))
        ...
        Trajectory park = drivetrain.trajectoryBuilder(new Pose2d(1, 18, Math.toRadians(-90)))

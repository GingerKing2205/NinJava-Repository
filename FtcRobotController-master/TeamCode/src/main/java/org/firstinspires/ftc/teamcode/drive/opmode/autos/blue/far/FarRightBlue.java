...
public class FarRightBlue {
    ...
    public void run(HardwareMap hardwareMap) {
        ...
        Trajectory toPurpleSpike = drivetrain.trajectoryBuilder(new Pose2d(0,0,0))
                .lineToLinearHeading(new Pose2d(24, -8.5, 0))
                .build();
        ...
        Trajectory drop = drivetrain.trajectoryBuilder(new Pose2d(24.5,-9,0))
                .lineToLinearHeading(new Pose2d(23.5, -9, 0))
                .build();
...
/*
        ...
        Trajectory awayBD = drivetrain.trajectoryBuilder(new Pose2d(25, -36, Math.toRadians(90)))

...
public class FarCenterBlue {
    ...
    public void run(HardwareMap hardwareMap) {
        ...
        //added to help claw drop, give more time
        Trajectory drop = drivetrain.trajectoryBuilder(new Pose2d(30, -6, 0))
                .lineToLinearHeading(new Pose2d(29, -7, 0))
                .build();
        drivetrain.followTrajectory(drop);
/*
        Trajectory toBD1 = drivetrain.trajectoryBuilder(new Pose2d(29, -7, 0))

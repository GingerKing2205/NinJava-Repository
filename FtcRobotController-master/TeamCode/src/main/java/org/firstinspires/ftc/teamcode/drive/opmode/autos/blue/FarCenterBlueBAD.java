...
@Autonomous
public class FarCenterBlueBAD extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory spikeToStack = drivetrain.trajectoryBuilder(new Pose2d(20,0,0))
        ...
        Trajectory throughTruss = drivetrain.trajectoryBuilder(new Pose2d(17, -8, Math.toRadians(-90)))
